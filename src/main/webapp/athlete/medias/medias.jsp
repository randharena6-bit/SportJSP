            ...
            <main class="p-8">
                ...
                <div class="bg-gradient-to-r from-red-600 to-rose-600 rounded-2xl p-6 mb-8 text-white">
                    <div class="flex items-center justify-between">
                        ...
                        <button class="px-6 py-3 bg-white text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition"><i class="fas fa-play mr-2"></i>Regarder le live</button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                        <div class="relative h-48 bg-gradient-to-br from-primary-600 to-primary-800">
                            <div class="absolute top-4 left-4 px-3 py-1 bg-blue-500 text-white rounded-lg text-sm font-medium flex items-center"><span class="w-2 h-2 bg-white rounded-full mr-2 animate-pulse"></span>LIVE</div>
