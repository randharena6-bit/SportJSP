            ...
            <header class="bg-white border-b border-slate-200 sticky top-0 z-30">
                <div class="px-8 py-4 flex items-center justify-between">
                    ...
                    <div class="flex gap-3">
                        <button class="px-4 py-2 bg-emerald-100 text-emerald-700 rounded-lg font-medium hover:bg-emerald-200"><i class="fas fa-file-export mr-2"></i>Export rapports</button>
                    </div>
                </div>
            </header>
            ...
            <main class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 bg-green-100 text-green-700 rounded text-xs mt-1">Actif</span>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-2 text-center mb-4">
                            ...
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-purple-600">87.5</div><div class="text-xs text-slate-500">Score IA</div></div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 bg-amber-100 text-amber-700 rounded text-xs mt-1">Blessée</span>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-2 text-center mb-4">
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-emerald-600">58.45s</div><div class="text-xs text-slate-500">400m PB</div></div>
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-emerald-600">2:15.20</div><div class="text-xs text-slate-500">800m PB</div></div>
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-purple-600">78.2</div><div class="text-xs text-slate-500">Score IA</div></div>
                        </div>
                        <div class="flex gap-2">
                            <button class="flex-1 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium hover:bg-blue-200"><i class="fas fa-chart-line mr-1"></i>Stats</button>
                            <button class="flex-1 py-2 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200"><i class="fas fa-heartbeat mr-1"></i>Santé</button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6">
                        ...
                        <div class="grid grid-cols-3 gap-2 text-center mb-4">
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-amber-600">6.85m</div><div class="text-xs text-slate-500">Longueur</div></div>
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-amber-600">14.20m</div><div class="text-xs text-slate-500">Triple</div></div>
                            <div class="bg-slate-50 rounded-lg p-2"><div class="text-lg font-bold text-purple-600">72.4</div><div class="text-xs text-slate-500">Score IA</div></div>
                        </div>
                        <div class="flex gap-2">
                            <button class="flex-1 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium hover:bg-blue-200"><i class="fas fa-chart-line mr-1"></i>Stats</button>
                            <button class="flex-1 py-2 bg-slate-100 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-200"><i class="fas fa-edit mr-1"></i>Saisie</button>
